            ...
            <div class="panel panel-info">
                <div class="panel-body">
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <p>
                                                    <form name='myForm'>
                                                        <input type="hidden" id="imp_ref_len"
                                                               value="<?php echo $num_fields; ?>">
                                                        <?php
                    ...
                    <button class="btn btn-warning disabled" type="button"
                            style="background:#ec971f;"><?php echo $selected_table_name; ?> has <span
                                class="badge"><?php echo $total_records; ?></span> entries
                    </button>
